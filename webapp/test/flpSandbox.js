		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "holamundo titulo app",
									"targetURL": "#p2cholaholamundo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"p2cholaholamundo-display": {
								"semanticObject": "p2cholaholamundo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=p2c.hola.holamundo",
									"url": sap.ui.require.toUrl("p2c/hola/holamundo")
								}
							}
						}
					}
